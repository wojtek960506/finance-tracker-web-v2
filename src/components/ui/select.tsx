  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        isDefaultSize
          ? `${FORM_CONTROL_SIZE_CLASS} pr-8 sm:pr-9`
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'relative z-[440] max-h-(--radix-select-content-available-height) min-w-36 origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-2xl border border-fg bg-modal-bg text-fg shadow-md data-[align-trigger=true]:animate-none',
          position === 'popper' &&
