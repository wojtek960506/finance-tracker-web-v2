...
vi.mock('@transactions/components/export-transactions', () => ({
  ExportTransactionsButton: () => <button type="button">exportTransactions</button>,
}));
    ...
    const response: TransactionsResponse = {
      ...
      items: [
        ...
        makeTransaction({
          ...
          category: { id: 'cat-2', type: 'user', name: 'Job' },
          paymentMethod: { id: 'pm-2', type: 'user', name: 'Bank' },
          account: { id: 'acc-2', type: 'user', name: 'Savings' },
        }),
      ],
    };
